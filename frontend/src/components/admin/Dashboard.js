          ...
          <dl className="mt-5 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
            <div className="relative overflow-hidden rounded-lg bg-gray-600 px-4 pb-12 pt-5 shadow sm:px-6 sm:pt-6">
              <dt>
                ...
                <p className="ml-16 truncate text-sm font-medium text-gray-300">Total Subscribers</p>
              </dt>
            ...
            <div className="relative overflow-hidden rounded-lg bg-gray-600 px-4 pb-12 pt-5 shadow sm:px-6 sm:pt-6">
              <dt>
                ...
                <p className="ml-16 truncate text-sm font-medium text-gray-300">Avg. Open Rate</p>
              </dt>
              <dd className="ml-16 flex items-baseline pb-6 sm:pb-7">
            ...
            <div className="relative overflow-hidden rounded-lg bg-gray-600 px-4 pb-12 pt-5 shadow sm:px-6 sm:pt-6">
              <dt>
                ...
                <p className="ml-16 truncate text-sm font-medium text-gray-300">Avg. Click Rate</p>
              </dt>
              <dd className="ml-16 flex items-baseline pb-6 sm:pb-7">
