...
export default function CreateBlog() {
  return (
    ...
    <div class="max-w-4xl p-6 mx-auto bg-indigo-600 rounded-md shadow-md dark:bg-gray-800 mt-20">
            <div>
                <label class="text-white dark:text-gray-200" for="username">หัวข้อ</label>
            ...
            <div>
                <label class="text-white dark:text-gray-200" for="passwordConfirmation">รายละเอียด</label>
