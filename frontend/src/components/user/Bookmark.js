...
export default function Bookmark() {
  ...
  useEffect(() => {
    const fetchBookmark = async () => {
      console.log(`BOOKMARK.GET_BY_USER_ID(user.id)`,BOOKMARK.GET_BY_USER_ID(user.id))
              ...
              <div className="-mb-6 mt-6 flow-root divide-y divide-gray-200 border-t border-gray-200">
                <div className="py-6 sm:flex">
                  <div className="flex space-x-4 sm:min-w-0 sm:flex-1 sm:space-x-6 lg:space-x-8">
                    ...
                    <div className="min-w-0 flex-1 pt-1.5 sm:pt-0">
                      ...
                      <p className="truncate text-sm text-gray-500">
                        <span>Author: {bookmark.author}</span>
                      </p>
                  ...
                  <div className="mt-6 space-y-4 sm:ml-6 sm:mt-0 sm:w-40 sm:flex-none">
                    <a href={`http://localhost:3000/blogs/${bookmark.blogId}`}
                      type="button"
